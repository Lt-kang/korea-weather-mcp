...
china_city_list = open(Path(__file__).parent / 'china_city.txt', 'r', encoding='utf-8').read().splitlines()
japan_city_list = open(Path(__file__).parent / 'japan_city.txt', 'r', encoding='utf-8').read().splitlines()
'''
